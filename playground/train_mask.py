...
from utils.newtrain_data import TrainData, dataset_collate, TrainDataWithMask
...
from utils.training import train_one_epoch, train_clip_one_epoch, train_conditional_one_epoch, train_mask_conditional_one_epoch
...
def main():
    ...
    train_dataset = TrainDataWithMask("../../../coco2voc/coco2voc/ImageSets/Main/trainval.txt")
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        current_step = train_mask_conditional_one_epoch(
            net,
            criterion,
            train_dataloader,
            optimizer,
